...
namespace Dots
{
    ...
    public partial struct WaveEndSystem : ISystem
    {
        [ReadOnly] private ComponentLookup<StatusSummon> _summonLookup;
        [ReadOnly] private BufferLookup<SummonEntities> _summonChildLookup;
        ...
        public void OnCreate(ref SystemState state)
        {
            ...
            _summonChildLookup = state.GetBufferLookup<SummonEntities>(true);
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            _summonChildLookup.Update(ref state);
